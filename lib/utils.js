...
const inject = (promise, client, threadId) => ({
    ...
    then: (...args) => inject(promise.then.apply(promise, args), client, threadId),
    catch: (...args) => inject(promise.catch.apply(promise, args), client, threadId),
    finally: (...args) => inject(promise.finally.apply(promise, args), client, threadId),
});
